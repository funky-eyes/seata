...
/**
 * base abstract class to create different raft servers
 */
public abstract class AbstractRaftServer implements RaftServer, Disposable {

    protected final Logger logger = LoggerFactory.getLogger(getClass());
    protected RaftStateMachine raftStateMachine;
    protected final String groupId;
    protected final String groupPath;
    protected final NodeOptions nodeOptions;
    protected final PeerId serverId;
